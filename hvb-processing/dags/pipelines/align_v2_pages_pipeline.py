...
with DAG(
    dag_id="hvb_align_v2_pages_pipeline",
    default_args=DEFAULT_ARGS,
    description="v2 step: DeepSeek align OCR JSON → hvb-aligned/{doc_id}/page_XXXX.json (pairs)",
    schedule_interval=None,
    catchup=False,
    max_active_runs=1,
    tags=["hvb", "v2", "align", "deepseek", "ramclouds", "k8s", "step"],
    params={
    ...
    build_hvb_k8s_pod_task(
        task_id="run_align_v2_page_loop",
        job_name="align_v2_pages",
