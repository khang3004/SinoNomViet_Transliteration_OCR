...
with DAG(
    dag_id="hvb_index_pairs_qdrant_pipeline",
    default_args=DEFAULT_ARGS,
    description="v2 step: index aligned pairs → Qdrant hvb_chau_ban_pairs (1 point / pair)",
    schedule_interval=None,
    catchup=False,
    max_active_runs=1,
    tags=["hvb", "v2", "qdrant", "index", "k8s", "step"],
    params={
    ...
    build_hvb_k8s_pod_task(
        task_id="run_index_pairs_qdrant",
        job_name="index_pairs_qdrant",
